      ...
      <div class="diary-card">
        ...
        <div class="emotion-grid">
          <div
            ...
            :class="{ selected: emotion.name === diaryForm.domiantEmotion }"
          >
        ...
        <div class="detail-form">
          ...
          <div class="form-group">
            ...
            <el-input
              ...
              placeholder="写下您今天的想法、感受或者发生的有趣事情..."
              type="textarea"
              rows="5"
              maxlength="3000"
              show-word-limit
...
const selectEmotion = (emotion) => {
  diaryForm.domiantEmotion = emotion;
};
